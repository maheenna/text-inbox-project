  ...
  return (
    <div id='Section8'>
        <div className='mt-[5rem] mb-[5rem]'>
            ...
            <button className='bg-[#0ECFC6] rounded-full hover:bg-[#0AAFA6] text-center ml-8 md:ml-[23.5rem] lg:ml-[33rem] mt-8 w-[80%] py-3 md:py-2 md:w-[15%]'>{section8.section8.button}</button>
        </div>
    </div>
  )
}

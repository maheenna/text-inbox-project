    ...
    <div className='mt-[5rem] mb-[3rem]' id='Section6'>
        ...
        <div className='w-[80%] md:w-[80%] mt-[5rem] md:mt-[3rem] mb-[3rem] mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[3rem] relative'>
                    ...
                    <div className='p-2 px-6 rounded-lg border-gray-200  border-3 border transition-all '>
                        ...
                        <button className='w-full outline hover:bg-[#0AAFA6] outline-1 py-[0.35rem] mb-0 outline-[#0ECFC6] rounded-full'>{section6.section6.cardbutton}</button>
                    </div>
                    ...
                    <div className='  transition-all'>
                        ...
                        <button className='w-[80%] mx-auto ml-6 hover:bg-[#0AAFA6]  py-[0.35rem] mb-12 bg-[#0ECFC6] rounded-full'>{section6.section6.cardbutton}</button>
                    </div>
                    </div>
                    ...
                    <div className='p-2 px-6 rounded-lg  border-gray-200 border-3 border transition-all'>
                        ...
                        <button className='w-full outline outline-1 py-[0.35rem] hover:bg-[#0AAFA6] mb-4 outline-[#0ECFC6] rounded-full'>{section6.section6.cardbutton}</button>
                    </div>
                </div>
    </div>
  )
